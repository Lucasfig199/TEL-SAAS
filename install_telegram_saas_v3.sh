...
# Versão: 3.0 (Cria ambiente virtual do zero - sem dependência do ZIP)
# Data: 27/06/2025
# =============================================================================
...
GITHUB_URL="https://github.com/Lucasfig199/TEL-SAAS/raw/main/telegram-saas.v3.zip"
...
cp telegram-saas.v2/telegram_api_v3.py "$INSTALL_DIR/"
cp telegram-saas.v2/config.json "$INSTALL_DIR/"
cp telegram-saas.v2/static/index.html "$INSTALL_DIR/static/"
